...
//07.Write a class GSMTest to test the GSM class:======================моят е MobilePhone=====my is MobilePhone==========
...
//10Add methods in the GSM class for
//adding and
//deleting calls from the calls history.
